...
Framework Directive (WFD ; \citep{directive2000eu}), cannot be
...
acquire ground truth data. This data is critical for calibrating and
...
framework. The integration of drone technology facilitates a scalable
...
informed and timely management decisions for the preservation and
